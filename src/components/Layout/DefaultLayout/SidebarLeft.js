        ...
        <div className="fixed-sidebar left">
            ...
            <div className="left-menu-full">
                <ul className="menu-slide">
                    <li><a className="closd-f-menu" href="#" title=""><i className="ti-close"></i> close Menu</a></li>
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-home"></i> Home Pages</a>
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-film"></i> Pittube</a>
                        <ul className="submenu">
                            <li><a href="pittube.html" title="">Pittube</a></li>
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-female"></i>PitPoint</a>
                        <ul className="submenu">
                            <li><a href="pitpoint.html" title="">PitPoint</a></li>
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-graduation-cap"></i>Pitjob</a>
                        <ul className="submenu">
                            <li><a href="career.html" title="">Pitjob</a></li>
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-repeat"></i>Timeline</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-heart"></i>Favourit Page</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-forumbee"></i>Forum</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-star-o"></i>Featured</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-gears"></i>Account Setting</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-lock"></i>Authentication</a>
                        <ul className="submenu">
                    ...
                    <li className="menu-item-has-children"><a className="" href="#" title=""><i className="fa fa-wrench"></i>Tools</a>
                        <ul className="submenu">
