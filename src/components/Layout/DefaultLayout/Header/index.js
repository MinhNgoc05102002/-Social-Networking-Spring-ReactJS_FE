                        ...
                        <li><a href="#" title="Help" data-ripple=""><i className="fa fa-question-circle"></i></a>
                            <div className="dropdowns helps">
                                ...
                                <ul className="help-drop">
                                    ...
                                    <li><a href="career.html" title=""><i className="fa fa-building-o"></i>Carrers</a>
                                    </li>
                    ...
                    <div className="user-img">
                        ...
                        <div className="user-setting">
                            ...
                            <ul className="log-out">
                                ...
                                <li><a href="setting.html" title=""><i className="ti-pencil-alt"></i>edit profile</a>
                                </li>
                                <li><a href="#" title=""><i className="ti-target"></i>activity log</a></li>
                                <li><a href="setting.html" title=""><i className="ti-settings"></i>account setting</a>
                                </li>
